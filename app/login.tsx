    ...
    >
      ...
      >
        <View className="flex-1 items-center justify-center px-6 py-12">
          ...
          <Text className="text-4xl font-bold text-center mb-1" style={{ color: colors.foreground }}>
            QUICKLOG
          </Text>
          <Text
          ...
          <View className="w-full mb-4">
            <Text className="text-xs font-bold tracking-wider mb-2 pl-1 uppercase" style={{ color: colors.muted }}>
              Phone Number
            </Text>
            <TextInput
